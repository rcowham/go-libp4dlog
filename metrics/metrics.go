...
func (p4m *P4DMetrics) getCumulativeMetrics() string {
	...
	p4m.outputMetric(metrics, "p4_cmd_running", "The number of running commands at any one time (deprecated use p4_cmds_running instead)", "gauge", fmt.Sprintf("%d", p4m.cmdsRunning), fixedLabels)
